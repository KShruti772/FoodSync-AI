...
> **Status**: Architecture Frozen — Single Source of Truth for Automated Testing  
...
## 1. Testing Philosophy & Pragmatic MVP Scope
...
│       ├── test_claims_routes.py      # Match acceptance, rejection & concurrency
...
### Run E2E Integration Tests (Optional):
```bash
npx playwright test
```
